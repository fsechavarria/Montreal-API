...
async function GET (req, res) {
	try {
      ...
      id_inscripcion: (req.params.id === null || typeof req.params.id === 'undefined' || isNaN(req.params.id) ) ? undefined : parseInt(req.params.id),
      ...
      id_curso: (req.query.id_curso === null || typeof req.query.id_curso === 'undefined' || isNaN(req.query.id_curso) || String(req.query.id_curso).trim().length === 0) ? undefined : parseInt(req.query.id_curso),
...
async function PUT (req, res) {
  try {
		const id_inscripcion = (req.params.id === null || typeof req.params.id  === 'undefined' || isNaN(req.params.id ) ) ? 0 : parseInt(req.params.id)
    if (id_inscripcion != 0) {
      let bindvars = {
        cursor: { type: oracledb.CURSOR, dir : oracledb.BIND_OUT },
        id_inscripcion: id_inscripcion,
        id_programa: (req.body.ID_PROGRAMA === null || typeof req.body.ID_PROGRAMA === 'undefined' || isNaN(req.body.ID_PROGRAMA) || String(req.body.ID_PROGRAMA).trim().length === 0) ? undefined : parseInt(req.body.ID_PROGRAMA),
        id_curso: (req.body.ID_CURSO === null || typeof req.body.ID_CURSO === 'undefined' || isNaN(req.body.ID_CURSO) || String(req.body.ID_CURSO).trim().length === 0) ? undefined : parseInt(req.body.ID_CURSO),
        id_alumno: (req.body.ID_ALUMNO === null || typeof req.body.ID_ALUMNO === 'undefined' || isNaN(req.body.ID_ALUMNO) || String(req.body.ID_ALUMNO).trim().length === 0) ? undefined : parseInt(req.body.ID_ALUMNO)
      }
