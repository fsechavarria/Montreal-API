...
async function GET (req, res) {
	try {
      ...
      id_programa: (req.params.id === null || typeof req.params.id === 'undefined' || isNaN(req.params.id) ) ? undefined : parseInt(req.params.id),
      id_cem: (req.query.id_cem === null || typeof req.query.id_cem === 'undefined' || isNaN(req.query.id_cem) || String(req.query.id_cem).trim().length === 0) ? undefined : parseInt(req.query.id_cem),
      id_cel: (req.query.id_cel === null || typeof req.query.id_cel === 'undefined' || isNaN(req.query.id_cel) || String(req.query.id_cel).trim().length === 0) ? undefined : parseInt(req.query.id_cel),
      nomb_programa: (req.query.nomb_programa === null ||  typeof req.query.nomb_programa !== 'string' || req.query.nomb_programa.trim().length === 0) ? undefined : req.query.nomb_programa.trim(),
      desc_programa: (req.query.desc_programa === null || typeof req.query.desc_programa !== 'string' || req.query.desc_programa.trim().length === 0) ? undefined : req.query.desc_programa.trim(),
      fech_inicio: (req.query.fech_inicio === null || typeof req.query.fech_inicio !== 'string' || req.query.fech_inicio.trim().length === 0 || !formatDate(req.query.fech_inicio.trim())) ? undefined : formatDate(req.query.fech_inicio.trim()),
      fech_termino: (req.query.fech_termino === null || typeof req.query.fech_termino !== 'string' || req.query.fech_termino.trim().length === 0 || !formatDate(req.query.fech_termino.trim())) ? undefined : formatDate(req.query.fech_termino.trim()),
      cant_min_alumnos: (req.query.cant_min_alumnos === null || typeof req.query.cant_min_alumnos === 'undefined' || isNaN(req.query.cant_min_alumnos) || String(req.query.cant_min_alumnos).trim().length === 0) ? undefined : parseInt(req.query.cant_min_alumnos),
      cant_max_alumnos: (req.query.cant_max_alumnos === null || typeof req.query.cant_max_alumnos === 'undefined' || isNaN(req.query.cant_max_alumnos) || String(req.query.cant_max_alumnos).trim().length === 0) ? undefined : parseInt(req.query.cant_max_alumnos),
		}
		let result = []
...
async function POST (req, res) {
  try {
    let bindvars = {
			cursor: { type: oracledb.CURSOR, dir : oracledb.BIND_OUT },
      id_cem: (req.body.ID_CEM === null || typeof req.body.ID_CEM === 'undefined' || isNaN(req.body.ID_CEM) || String(req.body.ID_CEM).trim().length === 0) ? undefined : parseInt(req.body.ID_CEM),
      id_cel: (req.body.ID_CEL === null || typeof req.body.ID_CEL === 'undefined' || isNaN(req.body.ID_CEL) || String(req.body.ID_CEL).trim().length === 0) ? undefined : parseInt(req.body.ID_CEL),
      nomb_programa: (req.body.NOMB_PROGRAMA === null || typeof req.body.NOMB_PROGRAMA !== 'string' || req.body.NOMB_PROGRAMA.trim().length === 0) ? undefined : req.body.NOMB_PROGRAMA.trim(),
      desc_programa: (req.body.DESC_PROGRAMA === null || typeof req.body.DESC_PROGRAMA !== 'string' || req.body.DESC_PROGRAMA.trim().length === 0) ? undefined : req.body.DESC_PROGRAMA.trim(),
      fech_inicio: (req.body.FECH_INICIO === null || typeof req.body.FECH_INICIO !== 'string' || req.body.FECH_INICIO.trim().length === 0 || !formatDate(req.body.FECH_INICIO.trim())) ? undefined : formatDate(req.body.FECH_INICIO.trim()),
      fech_termino: (req.body.FECH_TERMINO === null || typeof req.body.FECH_TERMINO !== 'string' || req.body.FECH_TERMINO.trim().length === 0 || !formatDate(req.body.FECH_TERMINO.trim())) ? undefined : formatDate(req.body.FECH_TERMINO.trim()),
      cant_min_alumnos: (req.body.CANT_MIN_ALUMNOS == null || typeof req.body.CANT_MIN_ALUMNOS === 'undefined' || isNaN(req.body.CANT_MIN_ALUMNOS) || String(req.body.CANT_MIN_ALUMNOS).trim().length === 0) ? undefined : parseInt(req.body.CANT_MIN_ALUMNOS),
      cant_max_alumnos: (req.body.CANT_MAX_ALUMNOS === null || typeof req.body.CANT_MAX_ALUMNOS === 'undefined' || isNaN(req.body.CANT_MAX_ALUMNOS) || String(req.body.CANT_MAX_ALUMNOS).trim().length === 0) ? undefined : parseInt(req.body.CANT_MAX_ALUMNOS),
    }
...
async function PUT (req, res) {
  try {
		const id_programa = (req.params.id === null || typeof req.params.id  === 'undefined' || isNaN(req.params.id ) ) ? 0 : parseInt(req.params.id)
    if (id_programa != 0) {
      let bindvars = {
        cursor: { type: oracledb.CURSOR, dir : oracledb.BIND_OUT },
